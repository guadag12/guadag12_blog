...
(function(){
try {
   var timings = [ { marker: 'knitr', elapsed: 48 }, { marker: 'pandoc', elapsed: 126 }, { marker: 'post-processor', elapsed: 17 }, { marker: 'pre-processor', elapsed: 4 }, { marker: 'render', elapsed: 766 } ];
